...
abstract class NFTColors extends Colors {
  factory NFTColors() {
    return NFTColorsImpl();
  }

  Color get primaryColor;

  Color get redSecondaryColor;

  Color get greenSecondaryColor;

  Color get yellowSecondaryColor;

  Color get blueSecondaryColor;
...
class NFTColorsImpl implements NFTColors {
